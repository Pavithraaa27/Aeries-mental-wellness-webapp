...
```bash
git clone https://github.com/yPavithraaa27/aeries.git
cd aeries
2️⃣ Backend Setup
cd backend
...
👥 80% of users found responses empathetic and helpful
🔐 Security
...
It is designed to provide supportive assistance only.
